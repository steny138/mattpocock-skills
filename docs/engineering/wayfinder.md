...
| A cleared wayfinder map | [to-spec](https://aihero.dev/skills-to-spec), then [to-tickets](https://aihero.dev/skills-to-tickets), [to-plan](https://aihero.dev/skills-to-plan), and [implement](https://aihero.dev/skills-implement) |
...
No. Wayfinder's tickets are decision tickets, and by the time the map closes they are all closed too. What is left is a map full of linked decisions, which is not a build plan. [to-spec](https://aihero.dev/skills-to-spec) collapses those linked decisions into one spec, [to-tickets](https://aihero.dev/skills-to-tickets) slices that into tracer-bullet implementation tickets, and [to-plan](https://aihero.dev/skills-to-plan) writes the disposable plan for the selected frontier ticket. Looping the map straight into [implement](https://aihero.dev/skills-implement) skips those boundaries and throws linked detail away.
