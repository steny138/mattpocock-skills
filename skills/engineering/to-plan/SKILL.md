...
Plan one work item only. For a set of tracer-bullet Issues, plan only the selected frontier Issue rather than the whole feature. This is not the cross-Issue planner removed when planning was unified into `/to-spec` and `/to-tickets`.
